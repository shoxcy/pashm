...
function IconButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className={`inline-flex h-10 w-10 items-center justify-center text-white/85 hover:text-white transition-colors ${className}`}
    >
      {children}
    </button>
  );
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 type-h1-d">
                  <div className="flex items-center gap-4 text-white/80 text-[16px] tracking-wide font-medium">
                    ...
                    {user ? (
                      <Link href="/account" className="text-[14px] hover:text-[#D6C78F] transition-colors">
